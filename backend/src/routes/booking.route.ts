...
import { createBooking, getAllBookings, getBookingById, getBookingsByDealer, updateBooking, deleteBooking, getLatestBookingVehicles } from '../controllers/booking.controller';
