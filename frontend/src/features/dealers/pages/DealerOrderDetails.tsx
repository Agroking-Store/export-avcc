          ...
          for (let qIdx = 0; qIdx < qty; qIdx++) {
            ...
            const booking = bookings.find(
              (b: any) =>
                b.orderId === id &&
                b.vehicles.some(
                  (bv: any) => String(bv.srNo) === String(expandedIndex + 1),
                ),
            );
            statusMap[expandedIndex] = booking
              ? booking.status
              : "To be Sourced";
  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center h-96 text-gray-500 dark:text-gray-400">
        ...
        <span className="text-[10px] font-bold uppercase tracking-widest ml-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            <div className="bg-white dark:bg-gray-900 rounded-[2rem] shadow-sm border border-gray-100 dark:border-gray-800 overflow-hidden transition-shadow hover:shadow-md">
              <div className="p-8 pb-4 flex justify-between items-center bg-gray-50/30 dark:bg-gray-800/30">
                <div className="flex items-center gap-3">
                  ...
                  <h2 className="text-xl font-bold text-[#1B2559] dark:text-white">
                    Order Vehicles
                  </h2>
                </div>
                ...
                {vehicleGroups.length > 0 && (
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {vehicleGroups.map((group, index) => (
                      <div
                        key={index}
                        className="bg-[#F8F9FB] dark:bg-gray-800 rounded-2xl p-5 border border-[#F1F3F6] dark:border-gray-700"
                      >
                    ...
                    <tbody className="divide-y divide-gray-50 dark:divide-gray-800">
                      {expandedVehicles.length === 0 ? (
                        <tr>
                          <td
                            colSpan={5}
                            className="py-12 text-slate-400 font-bold uppercase tracking-widest text-[10px]"
                          >
                        ...
                        expandedVehicles.map((v: any) => {
                          const vStatus =
                            vehicleStatuses[v.expandedIndex] || "To be Sourced";
                          ...
                          return (
                            ...
                            >
                              ...
                              <td className="px-6 py-5">
                                <span
                                  className={`inline-flex items-center px-3 py-1.5 rounded-full text-[10px] font-black uppercase tracking-wider border ${getStatusColor(vStatus)}`}
                                >
                                  {vStatus}
                                </span>
                              </td>
                                ...
                                <div className="flex items-center justify-end gap-2">
                                  ...
                                  <button
                                    onClick={() => {
                                      ...
                                      navigate(
                                        `/dealers/orders/${id}/vehicle-view/${v.expandedIndex}?${params.toString()}`,
                                      );
                                    }}
                                  ...
                                  <button
                                    onClick={() => {
                                      ...
                                      navigate(
                                        `/dealers/orders/${id}/vehicle-edit/${v.expandedIndex}?${params.toString()}`,
                                      );
                                    }}
                                  ...
                                  <button
                                    onClick={() => {
                                      ...
                                      navigate(
                                        `/dealers/booking/${id}/${v.expandedIndex}?${params.toString()}&refresh=true`,
                                      );
                                    }}
          ...
          <div className="lg:col-span-3 space-y-6 lg:sticky lg:top-8">
            ...
            <div className="bg-[#EBFDF5] dark:bg-emerald-900/20 rounded-3xl p-6 border border-[#D1FAE5] dark:border-emerald-800/50 shadow-sm transition-all hover:shadow-lg hover:-translate-y-1">
              ...
              <p className="text-xs font-bold text-emerald-500 dark:text-emerald-600 mt-2">
                Total Units
              </p>
            </div>
          </div>
