...
const AddDealer = () => {
  ...
  return (
    <div className="w-full">
      <DealerNav />
      <div className="bg-white dark:bg-gray-900 rounded-[2rem] shadow-sm border border-gray-100 dark:border-gray-800 px-6 py-8 md:px-10 md:py-10">
        {/* HEADER */}
        <div className="flex justify-between items-center mb-10">
          <div>
            <h1 className="text-2xl font-bold text-gray-800 dark:text-white">Add Dealer</h1>
            <p className="text-sm text-gray-500 mt-1">Create a new dealer profile</p>
          </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-10">
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-2 pb-2 border-b border-gray-50 dark:border-gray-800">
              ...
              <h2 className="text-base font-bold text-gray-700 dark:text-gray-200">Dealer Details</h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <input name="name" value={form.name} onChange={(e) => setForm({ ...form, name: e.target.value })} className={inputStyle} placeholder="John Motors" />
              </div>
              ...
              <div>
                ...
                <input name="contact" value={form.contact} onChange={(e) => setForm({ ...form, contact: e.target.value })} className={inputStyle} placeholder="+91 98765 43210" />
              </div>
              ...
              <div>
                ...
                <input name="email" value={form.email} onChange={(e) => setForm({ ...form, email: e.target.value })} className={inputStyle} placeholder="dealer@company.com" />
              </div>
              ...
              <div>
                ...
                <input name="gstNumber" value={form.gstNumber} onChange={(e) => setForm({ ...form, gstNumber: e.target.value.toUpperCase() })} className={inputStyle} placeholder="e.g. 27ACEFA0695F1ZH" />
                <p className="text-xs text-slate-400 mt-1 ml-1">Format: 27ACEFA0695F1ZH</p>
              </div>
              ...
              <div className="md:col-span-2">
                ...
                <textarea name="address" value={form.address} onChange={(e) => setForm({ ...form, address: e.target.value })}
                  className={`${inputStyle} resize-none`} placeholder="Full dealer address" rows={3} />
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row justify-end gap-4 pt-8 border-t border-gray-100 dark:border-gray-800">
            ...
            >
              {loading ? "Saving..." : <><PlusCircle size={18} /> Confirm & Save Dealer</>}
            </button>
          </div>
