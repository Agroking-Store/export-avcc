  ...
  const validateAll = (): boolean => {
    ...
    required.forEach((f) => {
      if (f === "chassisNo") {
        ...
        else if (!CHASSIS_REGEX.test(form.chassisNo.trim())) newErrors.chassisNo = "Invalid 17-char Chassis";
      } else {
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="md:col-span-2">
              ...
              <input value={form.name} onChange={e => setForm({ ...form, name: e.target.value })} className={inputStyle("name")} placeholder="TOYOTA LAND CRUISER" />
            ...
            <div>
              ...
              <input value={form.hsnCode} onChange={e => setForm({ ...form, hsnCode: e.target.value })} className={inputStyle("hsnCode")} placeholder="8703.23.01" />
            ...
            <div>
              ...
              <input value={form.color} onChange={e => setForm({ ...form, color: e.target.value })} className={inputStyle("color")} placeholder="Pearl White" />
            </div>

            <div>
              <label className={labelStyle}>Chassis Number</label>
              <input value={form.chassisNo} onChange={e => setForm({ ...form, chassisNo: e.target.value.toUpperCase() })} className={`${inputStyle("chassisNo")} font-mono`} placeholder="A1B2C3D4E5F6G7H8I" maxLength={17} />
            ...
            <div>
              ...
              <input value={form.engineNo} onChange={e => setForm({ ...form, engineNo: e.target.value.toUpperCase() })} className={`${inputStyle("engineNo")} font-mono`} placeholder="1GD-1234567" />
