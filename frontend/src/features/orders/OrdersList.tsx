      ...
      <div className="bg-white dark:bg-gray-900 rounded-[20px] shadow-sm border border-slate-200 dark:border-gray-800 overflow-hidden">
        ...
        <div className="px-8 py-6 flex justify-between items-center">
          ...
          <button
            ...
            className="cursor-pointer flex items-center gap-2 px-5 py-2.5 bg-linear-to-r from-[#5c67ff] to-[#3a47ff] hover:from-[#4a56ff] hover:to-[#2a37ff] text-white text-sm font-semibold rounded-xl shadow-md shadow-blue-200 transition-all active:scale-95"
          >
            ...
            <tbody className="divide-y divide-slate-100 dark:divide-gray-800">
              {orders.length === 0 && !loading ? (
                ...
                orders.map((order) => (
                  <tr
                    key={order._id}
                    className="hover:bg-slate-50/30 dark:hover:bg-gray-800/30 transition-colors"
                  >
          ...
          <div className="bg-white rounded-2xl w-[420px] p-6 shadow-2xl animate-in zoom-in-95">
            ...
            <div className="relative mb-6 group">
              ...
              <p className="mt-2 text-[10px] text-slate-400 flex items-center gap-1.5 ml-1">
                ...
                Only the current stage and the immediate next step can be
                selected.
              </p>
            </div>
            ...
            <div className="flex justify-end gap-3">
              ...
              <button
                ...
                className="cursor-pointer px-5 py-2.5 rounded-xl bg-linear-to-r from-blue-600 to-indigo-600 text-white font-semibold hover:opacity-95 shadow-md transition-all"
              >
                Update
              </button>
            </div>
