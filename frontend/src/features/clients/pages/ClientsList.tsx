          ...
          <div className="flex items-center gap-3">
            <div className="relative">
              ...
              <input
                ...
                className="pl-10 pr-4 py-2.5 w-64 text-sm bg-slate-50/30 dark:bg-gray-800 border border-slate-200 dark:border-gray-700 rounded-xl focus:ring-2 focus:ring-blue-500 outline-none transition-all"
              />
            </div>
                ...
                clients.map((client) => (
                  ...
                  <tr key={client._id} className="group transition-colors duration-200 hover:bg-blue-50/40 dark:hover:bg-gray-800/40">
                    ...
                    <td className="px-8 py-5 text-center">
                      ...
                      <div className="text-xs text-slate-400 dark:text-gray-500">{client.companyName || "India"}</div>
                    </td>
                    ...
                    <td className="px-8 py-5 text-center text-sm text-slate-600 dark:text-gray-300">
                      {client.lastTransaction ? new Date(client.lastTransaction).toLocaleDateString() : "4/9/2026"}
                    </td>
                    <td className="px-8 py-5 text-center">
