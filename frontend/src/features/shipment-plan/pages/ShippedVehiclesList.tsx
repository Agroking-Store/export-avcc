        ...
        <div className="px-8 py-6 flex justify-between items-center">
          <div>
            <h2 className="text-xl font-bold text-[#0f172a] dark:text-white">
              Shipped Vehicle Details
            </h2>
            <p className="text-sm text-slate-500 dark:text-gray-400 mt-1">
              View container-wise commercial invoice and LC details for shipped vehicles
            </p>
          </div>
        </div>
              ...
              {loading ? (
                ...
                shippingDetails.map((detail) => (
                  ...
                  >
                    ...
                    <td className="px-8 py-5 text-center">
                      <button
                        onClick={() => navigate(`/shipment-planning/shipped-view/${detail._id}`)}
                        ...
                        title="View Shipped Vehicle Details"
                      >
                        <Eye size={18} />
                      </button>
                    </td>
...
export default ShippedVehiclesList;
