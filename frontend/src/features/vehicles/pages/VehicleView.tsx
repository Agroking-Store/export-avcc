...
import VehicleDocumentViewModal from "../components/VehicleDocumentViewModal"; // New Import
...
const VehicleView = () => {
  ...
  const vehicleName =
    vehicleData?.name || searchParams.get("name") || "Unknown Model";
  const vehicleColor =
    vehicleData?.color || searchParams.get("color") || "Unknown";
          ...
          <div className="bg-white rounded-3xl shadow-sm border border-gray-100 p-6 md:p-8 transition-shadow hover:shadow-md">
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <InfoBox
                  label="Origin"
                  value={vehicleData?.countryOfOrigin}
                  icon={Globe}
                />
                <InfoBox
